...
public class PeticionEncender implements Serializable{
    ...
    public String toString() {
        return "PeticionEncender{" + "esRojoL1=" + esRojoL1 + ", esAmarilloL1=" + esAmarilloL1 + ", esVerdeL1=" + esVerdeL1 + ", esIntermitenteL1=" + esIntermitenteL1 + ", esRojoL2=" + esRojoL2 + ", esAmarilloL2=" + esAmarilloL2 + ", esVerdeL2=" + esVerdeL2 + ", esIntermitenteL2=" + esIntermitenteL2 + '}';
    }
